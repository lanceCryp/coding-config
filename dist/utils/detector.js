...
exports.detectToolInstallation = detectToolInstallation;
exports.getAllInstalledTools = getAllInstalledTools;
const fs = __importStar(require("fs-extra"));
const os = __importStar(require("os"));
const path = __importStar(require("path"));
async function detectToolInstallation(toolId) {
    let configPath = '';
    switch (toolId) {
        case 'cline':
...
async function getAllInstalledTools() {
